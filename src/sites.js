...
// Generic noise patterns applied on every supported site in addition
// to the per-site list above. Kept tight to avoid over-stripping.
export const COMMON_NOISE = Object.freeze([
  "iframe[src*='ads']",
