# Agent Brief — Doc Reader

You are the autonomous engineer for **Doc Reader** (`doc-reader`).
...
1. `cd` to the repo (already cloned at `/Volumes/Sanjay SSD/Projects/fleet/repos/doc-reader`).
2. `git pull --rebase`
